                ...
                <div className="container py-5">
                    ...
                    <div className=" d-flex " >
                        <div className="team-item p-2 ">
                            <img className="img-fluid rounded mx-auto d-block " src="assets/img/team-1.jpg" alt="" width={400} height={200} />
                            <div className="  text-center p-4">
                                <h4 className="mb-1">Dr Aqsa</h4>
                        ...
                        <div className="team-item p-2">
                            <img className="img-fluid rounded mx-auto d-block" src="assets/img/team-2.jpg" alt="" width={400} height={200} />
                            <div className=" text-center p-4">
                                <h4 className="mb-3">Ali Hassan</h4>
                        ...
                        <div className="team-item p-2">
                            <img className="img-fluid rounded mx-auto d-block " src="assets/img/team-3.jpg" alt="" width={400} height={200} />
                            <div className="bg text-center p-4">
                                <h4 className="mb-3">Dr Natasha</h4>
                        ...
                        <div className="team-item p-2">
                            <img className="img-fluid rounded mx-auto d-block" src="assets/img/team-4.jpg" alt="" width={400} height={200} />
                            <div className=" text-center p-4">
                                <h4 className="mb-3">Mr M Haris</h4>
