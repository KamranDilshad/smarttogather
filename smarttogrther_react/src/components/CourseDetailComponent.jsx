                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-8">
                            <div className="mb-5">
                                ...
                                <p>Students learn how to critically evaluate website quality, learn how to create and maintain quality web pages, learn about web design standards and why they're important, and learn to create and manipulate images. Web development is everything involved in the creation of a website. </p>

                                <p>Typically, it refers to the coding and programming side of web site production as opposed to the web design side. Benefits of studying web development inclue, There is an ever increasing demand for web developers: Businesses are always on a lookout for good web developers and designers and the demand is only going to grow in the future. .</p>
                            </div>

                            {/* slideeeeeeeer comonent start */}
                            <h2 className="mb-3">Related Courses</h2>
                            <Slider {...settings} className="related-carousel position-relative" style={{ padding: "0 30px" }}>
                        ...
                        <div className="col-lg-4 mt-5 mt-lg-0">
                            ...
                            <div className="mb-5">
                                ...
                                <a className="d-flex align-items-center text-decoration-none mb-4" href="">
                                    <img className="img-fluid rounded" src="assets/img/courses-80x80.jpg" alt="" />
                                    <div className="pl-3">
